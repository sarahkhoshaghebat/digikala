...
import pino from "../../images/pino.webp";
import creativelyVideo from "../../images/creatively video.webp";
import motorcycle from "../../images/motorcycle.webp";
import bestPrice from "../../images/best price.gif";
import climbing from "../../images/Climbing.webp";
import promate from "../../images/promate.webp";
import respi from "../../images/Respi.gif";
import shoes from "../../images/shoes.webp";
import week from "../../images/week.webp";

const HomeSlider = () => {
  const settings = {
    dots: true,  // برای نمایش دات‌ها
    infinite: true,
    speed: 500,
    slidesToShow: 1,
    slidesToScroll: 1,
